...
class Config:
    ...
    model_file = 'model/best_model_withWeights.pt'

    review_count = 5  # max review count
    ...
    lowest_review_count = 0  # reviews wrote by a user/item will be delete if its amount less than such value.
    PAD_WORD = '<UNK>'
